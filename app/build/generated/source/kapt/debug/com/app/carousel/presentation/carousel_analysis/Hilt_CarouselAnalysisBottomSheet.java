 ...
 */
public abstract class Hilt_CarouselAnalysisBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CarouselAnalysisBottomSheet() {
    super();
  }

  Hilt_CarouselAnalysisBottomSheet(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CarouselAnalysisBottomSheet_GeneratedInjector) this.generatedComponent()).injectCarouselAnalysisBottomSheet(UnsafeCasts.<CarouselAnalysisBottomSheet>unsafeCast(this));
    }
  }
